                                    ...
                                    <div class="card card-rounded">
                                        <div class="card-body">
                                            <div class="d-sm-flex justify-content-between align-items-start">
                                                ...
                                                <div>
                                                    <h4 class="card-title card-title-dash">All Customers</h4>
                                                </div>
                                                <div>
                                                    <a href="{{ url('createuser') }}" class="btn btn-primary btn-lg text-white mb-0 me-0">
                                                        <i class="mdi mdi-account-plus"></i> Add new customer
                                                    </a>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table select-table">
                                                    ...
                                                    @foreach($customers as $customer)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('admin.users.edit', $customer->id) }}" class="btn btn-primary">Edit</a>
